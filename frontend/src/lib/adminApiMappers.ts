...
export function mapBatchFolder(api: AdminBatchFolderResponse): AdminBatchFolder {
  return {
    ...
    clientThumbnailsFolderUrl: api.clientThumbnailsFolderUrl ?? undefined,
    creditCost: api.creditCost,
    creditsDebited: api.creditsDebited,
    clipOwnerKind: (api.clipOwnerKind as BatchStepOwnerKind) ?? null,
    thumbnailOwnerKind: (api.thumbnailOwnerKind as BatchStepOwnerKind) ?? null,
    titleOwnerKind: (api.titleOwnerKind as BatchStepOwnerKind) ?? null,
    ideaList: api.ideaList ?? null,
    pipelineStage: api.pipelineStage,
