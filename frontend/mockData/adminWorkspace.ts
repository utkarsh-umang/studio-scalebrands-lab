...
export const MOCK_ADMIN_BATCH_FOLDERS: AdminBatchFolder[] = [
  ...
  },
  {
    ...
    clientId: 'c-1',
    batchNumber: 25,
    title: 'B-roll pack — clips approved · submit your Videos folder',
    status: 'active',
    videoCount: 4,
  ...
  },
  {
    ...
    clientId: 'c-1',
    batchNumber: 27,
    title: 'Editor demo — SMM video QA notes',
    status: 'active',
    videoCount: 4,
  ...
  },
  {
    ...
    clientId: 'c-1',
    batchNumber: 28,
    title: 'Editor demo — client final QA notes',
    status: 'active',
    videoCount: 4,
    createdAt: '2026-05-13',
    updatedAt: '2026-05-14',
  ...
  },
  {
    ...
    clientId: 'c-1',
    batchNumber: 29,
    title: 'Editor demo — thumbnail upload & client review',
    status: 'active',
    videoCount: 4,
    createdAt: '2026-05-12',
    updatedAt: '2026-05-14',
  ...
  },
  {
    ...
    clientId: 'c-1',
    batchNumber: 30,
    title: 'Editor demo — publish titles for SMM',
    status: 'active',
    videoCount: 4,
    createdAt: '2026-05-11',
    updatedAt: '2026-05-14',
...
export const MOCK_ADMIN_VIDEO_TICKETS: AdminVideoTicket[] = [
    ...
    qaCommentHistory: [
      {
        ...
        kind: 'general',
        authorRole: 'smm',
        body: 'Audio ducking under VO around 0:18 — boost clarity.',
  ...
  {
    id: 'v-eqc-1',
    batchId: 'b-ed-qa-client',
    clientId: 'c-1',
    deliverableIndex: 1,
    title: 'Video 1 — client asked for tweaks',
    owner: 'editor',
    stageLabel: 'QA flagged',
    deadlineRole: 'editor',
    deadlineAt: '2026-05-15T18:00:00.000Z',
    ...
    qaCommentHistory: [
      {
        ...
        kind: 'general',
        authorRole: 'client',
        body: 'Love the pacing — can we swap the CTA frame for the alternate still?',
  ...
  },
  {
    ...
    clientId: 'c-1',
    deliverableIndex: 2,
    title: 'Video 2 — client asked for tweaks',
    owner: 'editor',
    stageLabel: 'QA flagged',
    deadlineRole: 'editor',
    deadlineAt: '2026-05-15T18:00:00.000Z',
  ...
  },
  {
    ...
    clientId: 'c-1',
    deliverableIndex: 1,
    title: 'Video 1 — needs publish title',
    owner: 'editor',
  ...
  },
  {
    ...
    clientId: 'c-1',
    deliverableIndex: 2,
    title: 'Video 2 — needs publish title',
    owner: 'editor',
    stageLabel: 'Video titles',
    deadlineRole: 'editor',
    deadlineAt: '2026-05-16T18:00:00.000Z',
  ...
  },
  {
    ...
    clientId: 'c-1',
    deliverableIndex: 3,
    title: 'Video 3 — needs publish title',
    owner: 'editor',
    stageLabel: 'Video titles',
    deadlineRole: 'editor',
    deadlineAt: '2026-05-16T18:00:00.000Z',
  ...
  },
  {
    ...
    clientId: 'c-1',
    deliverableIndex: 4,
    title: 'Video 4 — needs publish title',
    owner: 'editor',
    stageLabel: 'Video titles',
    deadlineRole: 'editor',
    deadlineAt: '2026-05-16T18:00:00.000Z',
