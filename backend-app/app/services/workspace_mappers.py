...
def batch_to_dto(batch: Batch) -> AdminBatchFolderResponse:
...
def _qa_flags_from_ticket(ticket: VideoTicket) -> list[dict[str, Any]] | None:
    if not ticket.qa_flags:
        return None
    if isinstance(ticket.qa_flags, list):
        return ticket.qa_flags
    return None
...
def video_to_dto(
    ...
    *,
    ...
    return AdminVideoTicketResponse(
        ...
        editor_workflow_phase=ticket.editor_workflow_phase,
